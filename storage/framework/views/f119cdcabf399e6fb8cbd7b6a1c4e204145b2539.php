                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div id="vertical-menu">
                                            ...
                                            <ul>
                                                ...
                                                <li class="mainLi">
                                                    <h3><span class="plus">+</span><input type="checkbox" class="parent_checkbox_<?php echo e($page->id); ?> parent_checkbox" data-id="<?php echo e($page->id); ?>" name="pages[]" value="<?php echo e($page->id); ?>"><?php echo e($page->label); ?></h3>
                                                    <ul>
                                                        ...
                                                        <li><input type="checkbox" name="methods[]" class="child_checkbox_<?php echo e($page->id); ?> child_checkbox" data-parent-id="<?php echo e($page->id); ?>" value="<?php echo e($method->id); ?>"> <?php echo e($method->label); ?></li>
